    ...
    <>
      ...
      <div className="flex flex-col min-h-screen container mx-auto px-6 py-12">
        <h1 className="text-5xl font-bold text-gray-900 mb-8 text-center">
          Introduction to Cirrus HRIS System
        </h1>

        {/* Section 1: Overview */}
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-gray-800">1. Overview</h2>
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-gray-800">2. Purpose of the HRIS System</h2>
          <p className="text-lg text-gray-700 leading-relaxed text-justify">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mt-4">Key Objectives:</h3>
          <ul className="list-disc pl-6 mt-2 text-lg text-gray-700">
            <li>Provide a <strong>centralized platform</strong> for all HR operations.</li>
            <li>Improve <strong>efficiency</strong> by automating repetitive HR tasks.</li>
            <li>Enhance <strong>accuracy</strong> in payroll, attendance, and employee data management.</li>
            <li>Facilitate <strong>real-time tracking</strong> of workforce activities.</li>
            <li>Support <strong>decision-making</strong> with data analytics and reports.</li>
            <li>Ensure <strong>compliance</strong> with labor laws and company policies.</li>
          </ul>
        </section>

        {/* Section 3: User Roles & Permissions */}
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-gray-800">3. Who Can Use This System?</h2>
          <p className="text-lg text-gray-700 leading-relaxed text-justify">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mt-4">User Roles & Permissions:</h3>
          <ul className="list-disc pl-6 mt-2 text-lg text-gray-700">
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-gray-800">4. Key Features of Cirrus HRIS System</h2>
          <h3 className="text-2xl font-semibold text-gray-800 mt-4">4.1 Employee Management</h3>
          <ul className="list-disc pl-6 mt-2 text-lg text-gray-700">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mt-4">4.2 Recruitment & Candidate Management</h3>
          <ul className="list-disc pl-6 mt-2 text-lg text-gray-700">
            <li>Track candidate applications, interviews, and hiring status.</li>
            <li>Automate the creation and approval of offer letters.</li>
          </ul>

          <h3 className="text-2xl font-semibold text-gray-800 mt-4">4.3 Attendance & Leave Tracking</h3>
          <ul className="list-disc pl-6 mt-2 text-lg text-gray-700">
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-gray-800">5. System Navigation & User Guide</h2>
          <p className="text-lg text-gray-700 leading-relaxed text-justify">
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-gray-800">6. System Benefits</h2>
          <h3 className="text-2xl font-semibold text-gray-800 mt-4">For HR Teams:</h3>
          <ul className="list-disc pl-6 mt-2 text-lg text-gray-700">
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-gray-800">7. Conclusion</h2>
          <p className="text-lg text-gray-700 leading-relaxed text-justify">
